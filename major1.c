...
int main()
{
    ...
    while (choice != 5) // This while loop contains the menu for the program
    {
        ...
        // second 32-bit number needed for option 3
        ...
        {
            case 1: // Count Leading Zeroes Case
               ...
               clz(num); // calls count leading zeroes function
            ...
            case 2: // Endian Swap Case
                ...
                endian(num); // calls endian function

                break;

            case 3: // Rotate-right case
                
                printf("Enter a 32-bit number (>= 1 and <= 4294967295, inclusively): "); //prompt user to$
                scanf("%d", &num);
                ...
                RightRotation(num, num2); // calls rotate right function
            ...
            case 4: // Parity case
                ...
                printf("Parity of %d is %d\n", num, parity(num)); // calls parity function
